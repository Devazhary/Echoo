    ...
    document.querySelectorAll("#contacts-list > div").forEach((item) => {
        item.addEventListener("click", () => {
            document.querySelectorAll("#contacts-list > div").forEach((i) => {
                i.classList.remove("bg-zinc-750", "border-purple-400");
                i.classList.add("border-transparent");
                i.querySelector(".user-image").classList.remove(
                    "ring-2",
                    "ring-purple-400"
                );
                i.querySelector(".time-box").classList.remove(
                    "text-purple-400"
                );
                i.querySelector(".time-box").classList.add("text-zinc-500");
            });
            item.classList.add("bg-zinc-750", "border-purple-400");
            item.classList.remove("border-transparent");
            item.querySelector(".user-image").classList.add(
                "ring-2",
                "ring-purple-400"
            );
            item.querySelector(".time-box").classList.add("text-purple-400");
